...
import com.roujiamo.http.http.config.BasicParamsInterceptor;
import com.roujiamo.http.http.config.HttpLoggingInterceptor;
...
//                .addConverterFactory(ResponseConverterFactory.create())
    ...
    private OkHttpClient getSingletonInstance() {
        ...
        return new OkHttpClient.Builder()
                ...
                .addInterceptor(new DoraemonInterceptor()) //网络请求监控的拦截器
                .addNetworkInterceptor(new DoraemonWeakNetworkInterceptor())//用于模拟弱网的拦截器
